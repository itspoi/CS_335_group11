...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!--about-us start -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-package-item">
                                <img src="images/images/packages/tanzania.jpg" alt="package-place">
                                <div class="single-package-item-txt">
                                    <h3>Tanzania <span class="pull-right">$499</span></h3>
        ...
        @endguest
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-package-item">
                                <img src="images/images/packages/turkey.jpg" alt="package-place">
                                <div class="single-package-item-txt">
                                    <h3>Turkey <span class="pull-right">$484</span></h3>
                                    <div class="packages-para">
                                        <p>
                                            <span>
                                                <i class="fa fa-angle-right"></i> 3 Days 2 nights
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-package-item">
                                <img src="images/images/packages/croatia.jpg" alt="package-place">
                                <div class="single-package-item-txt">
                                    <h3>Croatia <span class="pull-right">$290</span></h3>
                                    <div class="packages-para">
                                        <p>
                                            <span>
                                                <i class="fa fa-angle-right"></i> 4 Days 4 nights
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-package-item">
                                ...
                                <div class="single-package-item-txt">
                                    <h3>Italy <span class="pull-right">$799</span></h3>
                                    <div class="packages-para">
                                        <p>
                                            <span>
                                                <i class="fa fa-angle-right"></i> 4 Days 4 nights
